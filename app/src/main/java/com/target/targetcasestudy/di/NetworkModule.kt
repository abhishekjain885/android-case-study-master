...
import com.target.targetcasestudy.data.repository.DealsRepositoryImp
...
import com.target.targetcasestudy.util.Constants.BASE_URL
...
class NetworkModule {
    ...
    fun provideDealsRepository(
        ...
        return DealsRepositoryImp(retrofitService)
    }
/*
    @Singleton
    @Provides
